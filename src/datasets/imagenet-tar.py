...
import numpy as np
from .tarimagefolder import TarImageFolderWithPaths
...
class ImageNet:
    def __init__(self,
                 ...
                 batch_size=32,
                 num_workers=32,
                 use_tar=False):  # Add flag to switch between modes
    ...
    def populate_train(self):
        ...
        if self.use_tar:
            # Use TarImageFolder for tar files
            self.train_dataset = TarImageFolderWithPaths(
                traindir,
                transform=self.preprocess
            )
        else:
            # Original ImageFolder for extracted files
